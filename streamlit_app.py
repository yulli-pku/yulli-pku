...
with st.form("Inputvar"):
    ...
    AQI= st.sidebar.slider('Input AQI',0,10)
    PM10= st.sidebar.slider('Input PM10',0,10)
    PM2_5= st.sidebar.slider('Input PM2_5',0,10)	
    NO2= st.sidebar.slider('Input NO2',0,10)
    SO2= st.sidebar.slider('Input SO2',0,10)	
    O3= st.sidebar.slider('Input O3',0,10)
    Temperature= st.sidebar.slider('Input Temperature',0,10)
    Humidity= st.sidebar.slider('Input Humidity',0,10)	
    WindSpeed= st.sidebar.slider('Input WindSpeed',0,10)
